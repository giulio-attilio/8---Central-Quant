...
_FUNCTION_SPANS = {
    ...
    "MAIN_TRADE_CLOSE_OUTCOME_COMMIT": (11145, 11276),
    "MAIN_REGISTRY_MODE_SEGREGATION_COMMIT": (11715, 11814),
    "MAIN_MARK_REGISTRY_MISSING_TRADES": (14790, 14838),
    "MAIN_PREDATOR_PAPER_REGISTRY_SYNC": (49434, 49693),
    "MAIN_PREDATOR_ORPHAN_OPEN_FIX": (49870, 50069),
    "MAIN_PREDATOR_AUTO_CLOSED_SYNC": (67728, 67935),
    "MAIN_TRADE_REGISTRY_STORAGE_BOOTSTRAP": (50646, 51037),
}
_FRESH_MARKERS = {
