...
# V2.1 schema/validator statuses live here so the existing identity contract
# remains the single owner of shared execution/lifecycle identity statuses.
REGISTRY_SCHEMA_VALID = "REGISTRY_SCHEMA_VALID"
REGISTRY_SCHEMA_INVALID = "REGISTRY_SCHEMA_INVALID"
REGISTRY_SCHEMA_REQUIRED_FIELD_MISSING = "REGISTRY_SCHEMA_REQUIRED_FIELD_MISSING"
REGISTRY_SCHEMA_FIELD_INVALID = "REGISTRY_SCHEMA_FIELD_INVALID"
REGISTRY_SCHEMA_METADATA_CONFLICT = "REGISTRY_SCHEMA_METADATA_CONFLICT"
REGISTRY_SCHEMA_VERIFY_NOT_EXECUTION = "REGISTRY_SCHEMA_VERIFY_NOT_EXECUTION"
REGISTRY_SCHEMA_EXTERNAL_NOT_EXECUTION = "REGISTRY_SCHEMA_EXTERNAL_NOT_EXECUTION"
